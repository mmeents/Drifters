...
namespace Drifters.Core.Clients {
  ...
  /// <summary>
  /// Lightweight client for the LM Studio REST API.
  /// No auth required for local installs by default.
  /// </summary>
  public class LmStudioClient : ILmStudioClient, IDisposable {
    ...
    private string _baseUrl = Cx.WorldStateLMStudioUrl;
    ...
    public string? ApiToken { get => _apiToken; set {
      _apiToken = value;
      if (_http != null) {
    ...
    /// <param name="baseUrl">e.g. "http://10.0.0.118:8669"</param>
    /// <param name="apiToken">Optional bearer token. Leave null for unauthenticated local use.</param>
