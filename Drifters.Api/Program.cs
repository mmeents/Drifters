...
using Serilog;
using Serilog.Core;
using Drifters.Api.Extensions;
using System.Reflection;

namespace Drifters.Api {
  public class Program {
    public static async Task Main(string[] args) {
      ...
      if (app.Environment.IsDevelopment()) {
        ...
        {
          options.SwaggerEndpoint("v1/swagger.json", "Drifters.API V1");
        });
      }
      ...
      app.MapDrifterEndpoints()
         .MapDrifterCharacterEndpoints()
         .MapDrifterEngineEndpoints();
